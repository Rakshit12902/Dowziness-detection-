...
esp_err_t buzzer_on_handler(httpd_req_t *req) {
  ...
  httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*");
  httpd_resp_send(req, "Alert ON", HTTPD_RESP_USE_STRLEN);
  return ESP_OK;
}
...
esp_err_t buzzer_off_handler(httpd_req_t *req) {
  ...
  httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*");
  httpd_resp_send(req, "Alert OFF", HTTPD_RESP_USE_STRLEN);
  return ESP_OK;
}
void startCameraServer() {
  ...
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    // 🔥 REGISTER BUZZER
    httpd_register_uri_handler(camera_httpd, &buzzer_on_uri);
    httpd_register_uri_handler(camera_httpd, &buzzer_off_uri);
  }
